...

{
    ...
    {
        $db = DbConnect::getDb();
        $q= $db->prepare("INSERT INTO departements (libelleDepartement, idDepartement) VALUES (:libelleDepartement, ;idRegion)");
    ...
    public static function getListByRegion($api,$idRegion)
    {
        $id = (int) $idRegion;
        $db=DbConnect::getDb();
        $liste=[];
