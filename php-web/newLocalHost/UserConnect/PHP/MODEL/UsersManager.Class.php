...
class UsersManager
{
    ...
    {
        $db = DbConnect::getDb();
        $q = $db->prepare("INSERT INTO Users (nomUser,prenomUser,motDePasse,adresseMail,role,pseudo) VALUES (:nomUser,:prenomUser,:motDePasse,:adresseMail,:role,:pseudo)");
    ...
    {
        $db = DbConnect::getDb();
        $q = $db->prepare("UPDATE Users SET idUser=:idUser, nomUser=:nomUser, prenomUser=:prenomUser, motDePasse=:motDePasse, adresseMail=:adresseMail, role=:role, pseudo=:pseudo WHERE idUser=:idUser");
